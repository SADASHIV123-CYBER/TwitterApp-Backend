...
const replySchema = new mongoose.Schema({
  ...
  text: { type: String, trim: true, required: true, maxLength: [280, "Max comment length is 280 characters."] },
...
const RetweetSchema = new mongoose.Schema(
  {
    ...
    originalTweet: { type: mongoose.Schema.Types.ObjectId, ref: "Tweet", required: true, index: true },
...
const TweetSchema = new mongoose.Schema(
  {
    body: { type: String, trim: true, required: true, maxLength: [280, "Max limit is 280 characters."] },
    image: { type: String }, // Cloudinary URL
    author: { type: mongoose.Schema.Types.ObjectId, ref: "User", required: true, index: true },
    likes: [{ type: mongoose.Schema.Types.ObjectId, ref: "User" }],
    comments: [CommentSchema], // embedded subdocuments -> no separate Comment model required
    retweets: [{ type: mongoose.Schema.Types.ObjectId, ref: "Retweet" }],
    quoteTweets: [{ type: mongoose.Schema.Types.ObjectId, ref: "QuoteTweet" }],
